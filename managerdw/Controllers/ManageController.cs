...
namespace managerdw.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        [Authorize]
        [HttpPost]
        public RedirectToRouteResult AppointRoleUser(string User, string RoleId)
        {
            var user = context.Users.FirstOrDefault(a => a.Id == User);

            var role = context.Roles.FirstOrDefault(a => a.Id == RoleId);
